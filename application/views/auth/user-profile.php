...
<!-- Mirrored from html.designstream.co.in/pick/codeigniter/ltr/public/page/user-profile by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 14:31:09 GMT -->
        ...
        <ul id="side-menu" class="sidebar-menu">
            <li class="dropdown"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>                  
                <ul>
                    ...
                    <li><a href="../account.html"><i class="icon-layers"></i> Account</a></li>
                    <li><a href="../analytic.html"><i class="icon-grid"></i> Analytic</a></li>
                    <li><a href="../covid.html"><i class="icon-earphones"></i> COVID</a></li>
                    <li><a href="../crypto.html"><i class="icon-support"></i> Crypto</a></li>
                    <li><a href="../ecommerce.html"><i class="icon-briefcase"></i> Ecommerce</a></li>
                </ul>
            </li>
            <li class="dropdown"><a href="#"><i class="icon-organization mr-1"></i> Layout</a>
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-options"></i>Horizontal</a>
                        <ul class="sub-menu">
                            <li><a href="../layout2266.html?layout=horizontal-menu"><i class="icon-energy"></i> Light</a></li>
                            <li><a href="../layoutb1c1.html?layout=horizontal-menu&amp;color=semi-dark"><i class="icon-disc"></i> Semi Dark</a></li>
                            <li><a href="../layout59cc.html?layout=horizontal-menu&amp;color=dark"><i class="icon-frame"></i> Dark</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#"><i class="icon-options-vertical"></i>Vertical</a>
                        <ul class="sub-menu">
                            <li><a href="../layout8b17.html?layout=vertical-menu"><i class="icon-energy"></i> Light</a></li>
                            <li><a href="../layout8a92.html?layout=vertical-menu&amp;color=semi-dark"><i class="icon-disc"></i> Semi Dark</a></li>
                            <li><a href="../layout9c59.html?layout=vertical-menu&amp;color=dark"><i class="icon-frame"></i> Dark</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#"><i class="icon-grid"></i>Compact Menu</a>
                        <ul class="sub-menu">
                            <li><a href="../layout9b0c.html?layout=compact-menu"><i class="icon-energy"></i> Light</a></li>
                            <li><a href="../layout70b4.html?layout=compact-menu&amp;color=semi-dark"><i class="icon-disc"></i> Semi Dark</a></li>
                            <li><a href="../layout5d77.html?layout=compact-menu&amp;color=dark"><i class="icon-frame"></i> Dark</a></li>
                        </ul>
                    </li>
            ...
            <li class="dropdown"><a href="#"><i class="icon-layers mr-1"></i> Web Apps</a>                  
                <ul>
                    ...
                    <li><a href="../app/todo.html"><i class="icon-support"></i> Todo</a></li> 
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-chart"></i>Charts</a>                                
                        <ul class="sub-menu">                                    
                            ...
                            <li class="dropdown"><a href="#" class="d-flex align-items-center"><i class="icon-control-pause"></i> Charts js</a>                                          
                                <ul class="sub-menu">
                                    <li><a href="../chart/chartjs-bar.html"><i class="icon-energy"></i> Bar charts</a></li>
                                    <li><a href="../chart/chartjs-line.html"><i class="icon-disc"></i> Line charts</a></li>
                                    <li><a href="../chart/chartjs-area.html"><i class="icon-frame"></i> Area charts</a></li>
                                    <li><a href="../chart/chartjs-other.html"><i class="icon-fire"></i> Doughnut, Pie, Polar charts</a></li>
                                    <li><a href="../chart/chartjs-linear.html"><i class="icon-shuffle"></i> Linear scale</a></li>                                                                        
                                </ul>                                           
                            </li>
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="dropdown"><a href="#" class="d-flex align-items-center"><i class="icon-film"></i> Form Elements</a>                                          
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="../form/elements-radio.html"><i class="icon-frame"></i> Radio</a></li>
            ...
            <li class="dropdown"><a href="#"><i class="icon-doc mr-1"></i> Pages</a>                  
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-book-open"></i>Other Pages</a>                               
                        <ul class="sub-menu">
                            <li><a href="lockscreen.html"><i class="icon-lock"></i> Lockscreen</a></li>
                            <li><a href="login.html"><i class="icon-login"></i> login</a></li>
                            <li><a href="register.html"><i class="icon-direction"></i> Register</a></li>
                            <li><a href="404.html"><i class="icon-crop"></i> 404 Page</a></li>
                            <li><a href="404-menu.html"><i class="icon-layers"></i> 404 Page With Menu</a></li>
                            <li><a href="blank.html"><i class="icon-frame"></i> Blank Page</a></li>
                            <li><a href="gallery.html"><i class="icon-layers"></i> Gallery</a></li>
                            <li><a href="pricing.html"><i class="icon-wallet"></i> Pricing</a></li>
                            <li><a href="contact-us.html"><i class="icon-wrench"></i> Contact us</a></li>
                        </ul>                               
                    </li>
            ...
            <li class="dropdown"><a href="#"><i class="icon-support mr-1"></i> Extras</a>                   
                <ul>
                    <li class="dropdown"><a href="#"><i class="icon-map"></i>Map</a>                               
                        <ul class="sub-menu">
                            <li><a href="../extra/map-google.html"><i class="icon-map"></i> Google Map</a></li>
                            <li><a href="../extra/map-vector.html"><i class="icon-vector"></i> Vector Map</a></li>

                        </ul>                               
                    </li>
                    <li class="dropdown"><a href="#"><i class="icon-pencil"></i>Blog</a>                               
                        <ul class="sub-menu">
                            <li><a href="../extra/blog-list.html"><i class="icon-plus"></i> Blog List</a></li>
                            <li><a href="../extra/blog-single.html"><i class="icon-tag"></i> Blog Post</a></li>                            
                        </ul>                               
                    </li>  
                    <li class="dropdown"><a href="#"><i class="icon-bag"></i>Ecommerce</a>                                 
                        <ul class="sub-menu">
                            <li><a href="../extra/ecommerce-product-list.html"><i class="icon-grid"></i> Products List</a></li>
                            <li><a href="../extra/ecommerce-product-detail.html"><i class="icon-plus"></i> Product Detail</a></li>
                            <li><a href="../extra/ecommerce-cart.html"><i class="icon-badge"></i> Cart</a></li>
                            <li><a href="../extra/ecommerce-checkout.html"><i class="icon-plus"></i> Checkout</a></li>
                            <li><a href="../extra/ecommerce-orders.html"><i class="icon-basket"></i> Orders</a></li>
                            <li><a href="../extra/ecommerce-order-view.html"><i class="icon-equalizer"></i> Order View</a></li>                           
                    ...
                    <div class="row mt-4 portfolio-box">
                            ...
                            <div class="border">
                                <div class="card-body pb-0">
                                    ...
                                    <div id="demo" class="collapse show">
                                        <a href="dist/images/post1cedf.html?>"><img src="../dist/images/post1.jpg" data-toggle="lightbox" data-gallery="example-gallery" alt="" class="img-fluid"></a>
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author1.jpg" alt="" class="img-fluid rounded-circle d-flex mr-3" width="50"></a>
                                        <div class="media-body">
                                            <a class="bg-transparent border-0 collapsed redial-light float-right post-btn" data-toggle="collapse" data-target="#demo1"><i class="icon-arrow-down"></i></a>
                                            <span><a href="#" class="text-primary font-weight-bold">Harry Jones</a> Comments On This</span>
                                            <span class="d-block"><a href="#" class="font-weight-bold">23 minutes ago</a></span>
                                        </div>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetuer elit.<a href="#" class="text-primary font-weight-bold"> #Harry Jones</a></p>
                                    <div id="demo1" class="collapse show">
                                        <a href="dist/images/post1cedf.html?>"><img src="../dist/images/post2.jpg" data-toggle="lightbox" data-gallery="example-gallery" alt="" class="img-fluid"></a>
                                        <div class="clearfix my-2">
                                            <div class="float-sm-left float-none">
                                                <small><a href="#" class="font-weight-bold mr-2"><i class="fa fa-thumbs-up pr-1"></i> Like</a></small>
                                                <small><a href="#" class="font-weight-bold"><i class="fa fa-share pr-1"></i> Share</a></small>
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author2.jpg" width="30" alt="" class="img-fluid d-flex mr-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author3.jpg" alt="" class="img-fluid rounded-circle d-flex mr-3" width="50"></a>
                                        <div class="media-body">
                                            <a class="bg-transparent border-0 collapsed redial-light float-right post-btn" data-toggle="collapse" data-target="#demo2"><i class="icon-arrow-down"></i></a>
                                            <span><a href="#" class="text-primary font-weight-bold">Daniel Taylor</a> Comments On This</span>
                                            <span class="d-block"><a href="#" class="font-weight-bold">53 minutes ago</a></span>
                                        </div>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetuer elit.<a href="#" class="text-primary font-weight-bold"> #Daniel Taylor</a></p>
                                    <div id="demo2" class="collapse show">
                                        <a href="dist/images/post1cedf.html?>"><img src="../dist/images/post3.jpg" data-toggle="lightbox" data-gallery="example-gallery" alt="" class="img-fluid"></a>
                                        <div class="clearfix my-2">
                                            <div class="float-sm-left float-none">
                                                <small><a href="#" class="font-weight-bold mr-2"><i class="fa fa-thumbs-up pr-1"></i> Like</a></small>
                                                <small><a href="#" class="font-weight-bold"><i class="fa fa-share pr-1"></i> Share</a></small>
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author4.jpg" width="30" alt="" class="img-fluid d-flex mr-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author8.jpg" alt="" class="img-fluid rounded-circle d-flex mr-3" width="50"></a>
                                        <div class="media-body">
                                            <a class="bg-transparent border-0 collapsed redial-light float-right post-btn" data-toggle="collapse" data-target="#demo3"><i class="icon-arrow-down"></i></a>
                                            <span><a href="#" class="text-primary font-weight-bold">Charlotte </a> Comments On This</span>
                                            <span class="d-block"><a href="#" class="font-weight-bold">53 minutes ago</a></span>
                                        </div>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetuer elit.<a href="#" class="text-primary font-weight-bold"> #Charlotte </a></p>
                                    <div id="demo3" class="collapse show">
                                        <a href="dist/images/post1cedf.html?>"><img src="../dist/images/post4.jpg" data-toggle="lightbox" data-gallery="example-gallery" alt="" class="img-fluid"></a>
                                        <div class="clearfix my-2">
                                            <div class="float-sm-left float-none">
                                                <small><a href="#" class="font-weight-bold mr-2"><i class="fa fa-thumbs-up pr-1"></i> Like</a></small>
                                                <small><a href="#" class="font-weight-bold"><i class="fa fa-share pr-1"></i> Share</a></small>
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author6.jpg" width="30" alt="" class="img-fluid d-flex mr-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author7.jpg" alt="" class="img-fluid rounded-circle d-flex mr-3" width="50"></a>
                                        <div class="media-body">
                                            <a class="bg-transparent border-0 collapsed redial-light float-right post-btn" data-toggle="collapse" data-target="#demo4"><i class="icon-arrow-down"></i></a>
                                            <span><a href="#" class="text-primary font-weight-bold">Jack Sparrow</a> Comments On This</span>
                                            <span class="d-block"><a href="#" class="font-weight-bold">53 minutes ago</a></span>
                                        </div>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetuer elit.<a href="#" class="text-primary font-weight-bold"> #Jack Sparrow</a></p>
                                    <div id="demo4" class="collapse show">
                                        <a href="dist/images/post1cedf.html?>"><img src="../dist/images/post7.jpg" data-toggle="lightbox" data-gallery="example-gallery" alt="" class="img-fluid"></a>
                                        <div class="clearfix my-2">
                                            <div class="float-sm-left float-none">
                                                <small><a href="#" class="font-weight-bold mr-2"><i class="fa fa-thumbs-up pr-1"></i> Like</a></small>
                                                <small><a href="#" class="font-weight-bold"><i class="fa fa-share pr-1"></i> Share</a></small>
                                ...
                                <div class="card-body bg-light border border-bottom-0 border-left-0 border-right-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author8.jpg" width="30" alt="" class="img-fluid d-flex mr-2 mt-1"></a>
                                        <div class="media-body">
                                            <small><a href="#" class="text-primary font-weight-bold">Ruby Dixon</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula.</small>
                                            <small class="d-block"><a href="#" class="text-primary font-weight-bold">Like</a>. 
                                                <a href="#" class="text-primary font-weight-bold">Reply <sup>.</sup></a> 
                        ...
                        <div class="col-md-6 post mb-4" >
                            <div class="border">
                                <div class="card-body pb-0">
                                    <div class="media mb-3">
                                        <a href="#"><img src="../dist/images/author9.jpg" alt="" class="img-fluid rounded-circle d-flex mr-3" width="50"></a>
                                        <div class="media-body">
                                            <a class="bg-transparent border-0 collapsed redial-light float-right post-btn" data-toggle="collapse" data-target="#demo5"><i class="icon-arrow-down"></i></a>
                                            <span><a href="#" class="text-primary font-weight-bold">Wood Walton</a> Comments On This</span>
                                            <span class="d-block"><a href="#" class="font-weight-bold">53 minutes ago</a></span>
                                        </div>
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetuer elit.<a href="#" class="text-primary font-weight-bold"> #Wood Walton</a></p>
                                    <div id="demo5" class="collapse show">
                                        <a href="dist/images/post1cedf.html?>"><img src="../dist/images/post6.jpg" data-toggle="lightbox" data-gallery="example-gallery" alt="" class="img-fluid"></a>
                                        <div class="clearfix my-2">
                                            <div class="float-sm-left float-none">
                                                <small><a href="#" class="font-weight-bold mr-2"><i class="fa fa-thumbs-up pr-1"></i> Like</a></small>
                                                <small><a href="#" class="font-weight-bold"><i class="fa fa-share pr-1"></i> Share</a></small>
...
<!-- END: Back to top-->
        ...
        <script>
            var base_url = "http://html.designstream.co.in/pick/codeigniter/ltr/public";
        </script>
        <!-- START: Template JS-->
...
<!-- Mirrored from html.designstream.co.in/pick/codeigniter/ltr/public/page/user-profile by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Nov 2021 14:32:19 GMT -->
</html>
