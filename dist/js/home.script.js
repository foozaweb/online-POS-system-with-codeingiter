(function ($) {
	...
	if ($("#apex_today_order").length > 0) {
		...
		var chart1 = new ApexCharts(
			document.querySelector("#apex_today_order1"),
			options
		);
		chart1.render();

		var chart2 = new ApexCharts(
			document.querySelector("#apex_today_order2"),
			options
		);
		chart2.render();
	}
	...
	if ($("#apex_today_sale").length > 0) {
		...
		var chart1 = new ApexCharts(
			document.querySelector("#apex_today_sale1"),
			options
		);
		chart1.render();

		var chart2 = new ApexCharts(
			document.querySelector("#apex_today_sale2"),
			options
		);
		chart2.render();
	}
	if ($("#apex_today_profit").length > 0) {
		...
		var chart1 = new ApexCharts(
			document.querySelector("#apex_today_profit1"),
			options
		);
		chart1.render();

		var chart2 = new ApexCharts(
			document.querySelector("#apex_today_profit2"),
			options
		);
		chart2.render();
	}
	...
	var config = {
		...
		data: {
			datasets: [
				{
					data: [3, 28, 67],
					backgroundColor: ["#1e3d73", "#17a2b8", "#ffc107"],
					label: "Dataset 1",
				},
			],
